...
return [
    ...
    'parse_votes_desc' => 'Entrez plusieurs votes, un par ligne. Format : :format. Les lignes commençant par :comment sont ignorées.',
    'parse_votes_format' => 'A > B > C ^poids * quantité',
    'parse_votes_comment' => '#',
    ...
    'no_results_hint' => 'Ajoutez au moins :candidates et :vote pour calculer les résultats.',
    'no_results_hint_candidates' => '2 candidats',
    'no_results_hint_vote' => '1 vote',
    'no_results_methods_hint' => 'Puis sélectionnez une ou plusieurs :methods.',
    'no_results_methods_hint_methods' => 'méthodes de vote',
