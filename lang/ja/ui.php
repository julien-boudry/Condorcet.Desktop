...
return [
    ...
    'parse_votes_desc' => '1行に1票ずつ入力してください。形式：:format。:comment で始まる行は無視されます。',
    'parse_votes_format' => 'A > B > C ^重み * 数量',
    'parse_votes_comment' => '#',
    ...
    'no_results_hint' => '結果を計算するには、:candidatesと:voteを追加してください。',
    'no_results_hint_candidates' => '2人以上の候補者',
    'no_results_hint_vote' => '1票以上',
    'no_results_methods_hint' => '次に、1つ以上の:methodsを選択してください。',
    'no_results_methods_hint_methods' => '投票方式',
