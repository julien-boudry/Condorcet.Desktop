...
return [
    ...
    'donate' => 'Donar',
    'condorcet_wikipedia' => 'Método de Condorcet',
    ...
    'parse_votes_desc' => 'Introduzca varios votos, uno por línea. Formato: :format. Las líneas que empiezan con :comment se ignoran.',
    'parse_votes_format' => 'A > B > C ^peso * cantidad',
    'parse_votes_comment' => '#',
    ...
    'no_results_hint' => 'Añada al menos :candidates y :vote para calcular los resultados.',
    'no_results_hint_candidates' => '2 candidatos',
    'no_results_hint_vote' => '1 voto',
    'no_results_methods_hint' => 'Luego seleccione uno o más :methods.',
    'no_results_methods_hint_methods' => 'métodos de votación',
    ...
    'n_invalid_under_constraints' => ':count voto rechazado por restricciones|:count votos rechazados por restricciones',
    'status' => 'Estado',
    'vote_valid' => 'Válido',
    'vote_invalid' => 'Rechazado',
    'vote_rejected_by_constraint' => 'Este voto es rechazado por la(s) restricción(es) activa(s) y se excluye del cálculo.',
