...
return [
    ...
    'parse_votes_desc' => 'Enter multiple votes, one per line. Format: :format. Lines starting with :comment are ignored.',
    'parse_votes_format' => 'A > B > C ^weight * quantity',
    'parse_votes_comment' => '#',
    ...
    'no_results_hint' => 'Add at least :candidates and :vote to compute results.',
    'no_results_hint_candidates' => '2 candidates',
    'no_results_hint_vote' => '1 vote',
    'no_results_methods_hint' => 'Then select one or more :methods.',
    'no_results_methods_hint_methods' => 'voting methods',
