...
return [
    ...
    'parse_votes_desc' => 'Kɔmɛ mipɔ́si mí mingi, epɔ́si ɛmɔ́sɔ́ na lɛ́n ɛmɔ́sɔ́. Fɔ́rma: :format. Malɛ́n ma bwámbisɛ na :comment ma úba.',
    'parse_votes_format' => 'A > B > C ^bwámu * ndɔgɔ',
    'parse_votes_comment' => '#',
    ...
    'no_results_hint' => 'Bɛ́nɛ ngɛ́a :candidates na :vote i sálɛ bipɔdɔl.',
    'no_results_hint_candidates' => 'bato ba dipɔ́si 2',
    'no_results_hint_vote' => 'epɔ́si 1',
    'no_results_methods_hint' => 'Ná pɔ̃ :methods ɛmɔ́sɔ́ ɔ ma mingi.',
    'no_results_methods_hint_methods' => 'manjɛ́l ma mipɔ́si',
