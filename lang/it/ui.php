...
return [
    ...
    'donate' => 'Dona',
    'condorcet_wikipedia' => 'Metodo di Condorcet',
    ...
    'parse_votes_desc' => 'Inserisci più voti, uno per riga. Formato: :format. Le righe che iniziano con :comment vengono ignorate.',
    'parse_votes_format' => 'A > B > C ^peso * quantità',
    'parse_votes_comment' => '#',
    ...
    'no_results_hint' => 'Aggiungi almeno :candidates e :vote per calcolare i risultati.',
    'no_results_hint_candidates' => '2 candidati',
    'no_results_hint_vote' => '1 voto',
    'no_results_methods_hint' => 'Poi seleziona uno o più :methods.',
    'no_results_methods_hint_methods' => 'metodi di voto',
    ...
    'pairwise_desc' => 'Ogni cella mostra le :wins / :losses del candidato di riga contro quello di colonna.',
    'pairwise_wins' => 'vittorie',
    'pairwise_losses' => 'sconfitte',
    'vs' => 'vs.',
    ...
    'reset_during_loading' => 'Ripristina elezione',
