...
return [
    ...
    'parse_votes_desc' => 'أدخل عدة أصوات، واحد في كل سطر. الصيغة: :format. الأسطر التي تبدأ بـ :comment يتم تجاهلها.',
    'parse_votes_format' => 'A > B > C ^وزن * كمية',
    'parse_votes_comment' => '#',
    ...
    'no_results_hint' => 'أضف على الأقل :candidates و:vote لحساب النتائج.',
    'no_results_hint_candidates' => 'مرشحَين',
    'no_results_hint_vote' => 'صوتًا واحدًا',
    'no_results_methods_hint' => 'ثم اختر :methods واحدة أو أكثر.',
    'no_results_methods_hint_methods' => 'طريقة تصويت',
