...
return [
    ...
    'donate' => 'Přispět',
    'condorcet_wikipedia' => 'Condorcetova metoda',
    'created_by' => 'Vytvořil',
    ...
    'parse_votes_desc' => 'Zadejte více hlasů, jeden na řádek. Formát: :format. Řádky začínající :comment jsou ignorovány.',
    'parse_votes_format' => 'A > B > C ^váha * množství',
    'parse_votes_comment' => '#',
    ...
    'no_results_hint' => 'Přidejte alespoň :candidates a :vote pro výpočet výsledků.',
    'no_results_hint_candidates' => '2 kandidáty',
    'no_results_hint_vote' => '1 hlas',
    'no_results_methods_hint' => 'Poté vyberte jednu nebo více :methods.',
    'no_results_methods_hint_methods' => 'volebních metod',
