...
return [
    ...
    'parse_votes_desc' => 'Wprowadź wiele głosów, po jednym na linię. Format: :format. Linie zaczynające się od :comment są pomijane.',
    'parse_votes_format' => 'A > B > C ^waga * ilość',
    'parse_votes_comment' => '#',
    ...
    'no_results_hint' => 'Dodaj co najmniej :candidates i :vote, aby obliczyć wyniki.',
    'no_results_hint_candidates' => '2 kandydatów',
    'no_results_hint_vote' => '1 głos',
    'no_results_methods_hint' => 'Następnie wybierz jedną lub więcej :methods.',
    'no_results_methods_hint_methods' => 'metod głosowania',
