...
return [
    ...
    'donate' => 'Пожертвовать',
    'condorcet_wikipedia' => 'Метод Кондорсе',
    'created_by' => 'Автор',
    ...
    'parse_votes_desc' => 'Введите несколько голосов, по одному на строку. Формат: :format. Строки, начинающиеся с :comment, игнорируются.',
    'parse_votes_format' => 'A > B > C ^вес * количество',
    'parse_votes_comment' => '#',
    ...
    'no_results_hint' => 'Добавьте как минимум :candidates и :vote для вычисления результатов.',
    'no_results_hint_candidates' => '2 кандидатов',
    'no_results_hint_vote' => '1 голос',
    'no_results_methods_hint' => 'Затем выберите один или несколько :methods.',
    'no_results_methods_hint_methods' => 'методов голосования',
    ...
    'n_invalid_under_constraints' => ':count голос отклонён ограничениями|:count голосов отклонено ограничениями',
    'status' => 'Статус',
    'vote_valid' => 'Действителен',
    'vote_invalid' => 'Отклонён',
    'vote_rejected_by_constraint' => 'Этот голос отклонён активным ограничением(ями) и исключён из вычисления.',
