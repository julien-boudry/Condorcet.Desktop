...
return [
    ...
    'parse_votes_desc' => 'Ŋwa̍ʼ mtsǒ ŋkwɛ̌ mɛ̌ntsǒ, ntsǒ ŋkwɛ̌ mɔ̀ʼ pə́ mɔ̀ʼ kɛ̀ʼ. Ntʉɔ: :format. Mkɛ̀ʼ myǎ lɑ̀ nə̀ :comment tə̀ pɑ̀ ŋkhǔm.',
    'parse_votes_format' => 'A > B > C ^gʉ̀ʼ * ŋkhʉ̀ɔ̌',
    'parse_votes_comment' => '#',
    ...
    'no_results_hint' => 'Gùŋ tə̀ :candidates pú :vote pə́ ŋkhǔm mfʉ̀ʼ.',
    'no_results_hint_candidates' => 'pɑ̌ kwɛ̌ 2',
    'no_results_hint_vote' => 'ntsǒ ŋkwɛ̌ 1',
    'no_results_methods_hint' => 'Pɑ̀ shyǎ :methods mɔ̀ʼ kɑ pɑ̀ yɔ̀m.',
    'no_results_methods_hint_methods' => 'mbhʉ̀ɔ̀ mtsǒ ŋkwɛ̌',
