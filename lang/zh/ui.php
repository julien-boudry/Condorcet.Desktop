...
return [
    ...
    'parse_votes_desc' => '每行输入一张投票。格式：:format。以 :comment 开头的行将被忽略。',
    'parse_votes_format' => 'A > B > C ^权重 * 数量',
    'parse_votes_comment' => '#',
    ...
    'no_results' => '无结果显示',
    'no_results_hint' => '添加至少 :candidates 和 :vote 来计算结果。',
    'no_results_hint_candidates' => '2 个候选人',
    'no_results_hint_vote' => '1 张选票',
    'no_results_methods_hint' => '然后选择一个或多个 :methods。',
    'no_results_methods_hint_methods' => '投票方法',
