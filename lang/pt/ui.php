...
return [
    ...
    'parse_votes_desc' => 'Introduza vários votos, um por linha. Formato: :format. As linhas que começam com :comment são ignoradas.',
    'parse_votes_format' => 'A > B > C ^peso * quantidade',
    'parse_votes_comment' => '#',
    ...
    'no_results_hint' => 'Adicione pelo menos :candidates e :vote para calcular os resultados.',
    'no_results_hint_candidates' => '2 candidatos',
    'no_results_hint_vote' => '1 voto',
    'no_results_methods_hint' => 'Depois selecione um ou mais :methods.',
    'no_results_methods_hint_methods' => 'métodos de votação',
    ...
    'pairwise_desc' => 'Cada célula mostra as :wins / :losses do candidato na linha contra o candidato na coluna.',
    'pairwise_wins' => 'vitórias',
    ...
    'reset_during_loading' => 'Reiniciar eleição',
