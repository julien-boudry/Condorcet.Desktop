...
return [
    ...
    'parse_votes_desc' => 'Tila bisombo bi yôm, sombo yada i lign yada. Bégés: :format. Malign ma bôdôl ni :comment ma héñla.',
    'parse_votes_format' => 'A > B > C ^ngidja * ndôg',
    'parse_votes_comment' => '#',
    ...
    'no_results_hint' => 'Bôñôl gwal :candidates ni :vote i kayéh bipôdôl.',
    'no_results_hint_candidates' => 'bôt ba somb 2',
    'no_results_hint_vote' => 'sombo 1',
    'no_results_methods_hint' => 'Hégda nyañ :methods yada tole ma yôm.',
    'no_results_methods_hint_methods' => 'manjel ma bisombo',
