...
<div class="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-4">
    <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">Votes</h2>
    ...
    <form wire:submit="addVote" class="space-y-2 mb-3">
        ...
        <input
            ...
            placeholder="Alice > Bob > Charlie  or  Alice = Bob > Charlie"
        ...
        <div class="flex gap-2">
            ...
            @if($weightAllowed)
                <div class="flex-1">
                    <label class="text-xs font-medium text-gray-700 dark:text-gray-300">Weight</label>
                    <input
                        type="number"
